...
import { GithubIcon, GmailIcon, LinkedinIcon,TwitterIcon,Instagram,Discord } from "../assets/icons";
  ...
  return (
    ...
    >
      <div className="video-background-container  w-full max-w-6xl  rounded-2xl shadow-lg overflow-hidden grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="relative w-full h-full order-2 md:order-1">
          ...
          <div className="relative z-20 p-8 sm:p-12 flex flex-col justify-center  text-text-primary">
            ...
            <ul className="space-y-4">
              ...
              <li>📧<span className="text-white/70"> Email:</span><span className="text-inherit select-all">{contactDetails.email}</span></li>
              <li>📞<span className="text-white/70">Phone: </span> {contactDetails.phone}</li>
            </ul>
                ...
                {Object.entries(socialLinks).map(([key, link]) => {
                  ...
                  return (
                    <a
                      ...
                      className={` text-white backdrop-blur-lg bg-black/70 p-2 rounded-full hover:text-blue-300 transition transform hover:scale-110`}
                    >
                      <Icon />
                    </a>
                  );
        ...
        {/* Right Side – Form */}
        <div className="p-8 sm:p-12 border-b md:border-b-0 md:border-l border-gray-200 order-1 md:order-2">
